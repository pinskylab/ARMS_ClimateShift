...
ggsave("map1.png", plot = map1, device = NULL, path = "draft_figures", width = 2)
...
ggsave("plot2.png", plot = plot2, device = NULL, path = "draft_figures", width = 2)
...
plot3 <- ggplot(data = depth_shift_summaries, aes(x = Depth, y = freq, fill = tempchange)) +
  ...
  theme_bw()
plot3
ggsave("plot3.png", plot = plot3, device = NULL, path = "draft_figures", width = 2)
